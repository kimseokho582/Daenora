...
class _CustomMenuTabbarState extends State<CustomMenuTabbar>
  ...
  initState() {
    ...
    // List<Widget> foodList = [
    //   _MenuList(name: "내가 쓴 리뷰"),
    //   _MenuList(name: "저장한 맛집"),
    //   _MenuList(name: "마이페이지"),
    //   _MenuList(name: "리뷰 작성"),
    // ];
  }
